...
# ==============================================================================
                ...
                if p_data['grupos_equipamentos']:
                    ...
                    for g_idx, g_data in enumerate(p_data['grupos_equipamentos']):
                        with abas_equipamentos[g_idx]:
                            ...
                            is_monitoramento = st.checkbox("📍 Exclusivo para Monitoramento/Controle Passivo (Sem intertravamento de painel)", value=st.session_state.get(f"chk_mon_{p_data['id']}_{g_idx}", auto_mon_default), key=f"chk_mon_{p_data['id']}_{g_idx}")
    ...
    with aba_resumo:
        ...
        if total_geral > 0:
            ...
            # PROTEÇÃO CONTRA A TUPLA VAZIA (O erro dos "None" repetidos)
            expl = []
