...
# ==============================================================================
    ...
    GRUPOS_INSTRUMENTOS = {
        ...
        "🔸 Monitoramento (Filtros e Status)": [
            ...
            "Transmissor de pressão diferencial (monitorar os filtros F9) (PDT)", "Transmissor de pressão diferencial (monitorar os filtros H13) (PDT)",
        ...
        for p_idx, p_data in enumerate(st.session_state.paineis_auto):
            ...
            with st.expander(f"🎛️ Quadro: {p_data['nome']} - {p_data.get('arquitetura', '')}", expanded=(p_idx == 0)):
                ...
                for g_data in p_data['grupos_equipamentos']:
                    ...
                    is_monitoramento = st.session_state.get(f"chk_mon_{p_data['id']}_{p_data['grupos_equipamentos'].index(g_data)}", ("SALA" in g_data['nome_grupo'].upper() or "MONITORAMENTO" in g_data['nome_grupo'].upper()))
    ...
    with aba_resumo:
        ...
        for p in st.session_state.paineis_auto:
            ...
            for g_idx, g in enumerate(p['grupos_equipamentos']):
                ...
                is_monitoramento = st.session_state.get(f"chk_mon_{p['id']}_{g_idx}", ("SALA" in g['nome_grupo'].upper() or "MONITORAMENTO" in g['nome_grupo'].upper()))
